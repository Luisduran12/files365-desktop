    ...
    , _ui(new Ui::GeneralSettings)
{
    ...
    connect(_ui->btnLangEn, &QPushButton::clicked, this, &GeneralSettings::slotLangEnClicked);
    connect(_ui->btnLangEs, &QPushButton::clicked, this, &GeneralSettings::slotLangEsClicked);
...
void GeneralSettings::slotLangEnClicked()
{
    ConfigFile().setLanguage(QStringLiteral("en"));
    QMessageBox::information(this, tr("Language changed"), tr("Please restart the application to apply the language changes."));
}

void GeneralSettings::slotLangEsClicked()
{
    ConfigFile().setLanguage(QStringLiteral("es"));
    QMessageBox::information(this, tr("Language changed"), tr("Please restart the application to apply the language changes."));
}

...
QtObject {
    ...
    // Files365 Semantic Tokens
    readonly property color primaryColor: ncBlue
    readonly property color primaryHoverColor: darkMode ? Qt.lighter(primaryColor, 1.2) : Qt.lighter(primaryColor, 1.1)
    readonly property color primaryPressedColor: darkMode ? Qt.darker(primaryColor, 1.2) : Qt.darker(primaryColor, 1.1)
    readonly property color secondaryColor: darkMode ? "#303b43" : "#e7eef4"
    readonly property color accentBrightColor: darkMode ? "#4da3d4" : "#0076b5"
    readonly property color backgroundColor: darkMode ? "#202124" : "#ffffff"
    readonly property color surfaceColor: darkMode ? "#292a2d" : "#f5f8fa"
    readonly property color cardColor: darkMode ? "#292d30" : "#ffffff"
    readonly property color textPrimaryColor: darkMode ? "#f1f3f4" : "#111111"
    readonly property color textSecondaryColor: darkMode ? Qt.rgba(1, 1, 1, 0.68) : Qt.rgba(0, 0, 0, 0.62)
    readonly property color borderColor: darkMode ? "#3c454c" : "#e1e8ee"
    readonly property color successColor: darkMode ? "#4caf50" : "#2e7d32"
    readonly property color warningColor: darkMode ? "#f2b84b" : "#8a5200"
    readonly property color errorColor: darkMode ? "#ff7b86" : "#b00020"
    readonly property color infoColor: darkMode ? "#64b5f6" : "#0277bd"
    ...
    property int trayWindowRadius: 16
    // dropdown menus radius
    property int halfTrayWindowRadius: 8
